...
<script setup lang="ts">
    ...
    import chinaMap from '@/views/screen/json/chinaMap.json';
                    ...
                    data: [
                        {
                            coords: [
                                ...
                                [104.065735, 30.659462]   // 终点,四川
                            ],
                        },
                        {
                            coords: [
                                [104.065735, 30.659462],// 起点 四川
                                [116.405285, 39.904989]  // 终点,北京
                            ],
                        },
                        {
                            coords: [
                                [88.388277, 31.56375],// 起点
